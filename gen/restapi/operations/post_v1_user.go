...
type PostV1UserHandlerFunc func(PostV1UserParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn PostV1UserHandlerFunc) Handle(params PostV1UserParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// PostV1UserHandler interface for that can handle valid post v1 user params
type PostV1UserHandler interface {
	Handle(PostV1UserParams, *models.Principal) middleware.Responder
}
...
/*
	PostV1User swagger:route POST /v1/user postV1User
